...
def load_pytorch_weights(weights_path='model_weights.pth', num_filters=128, num_res_blocks=5, device='cpu'):
    """
...
def load_numpy_weights(weights_path='weights_numpy/model_weights.npz', num_filters=128, num_res_blocks=5, device='cpu'):
    """
